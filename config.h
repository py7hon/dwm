...
static const char col_cyan[]        = "#577CA1";
...
static Key keys[] = {
	...
	{ 0,                            XK_Print,  spawn,          SHCMD("maim ~/Screenshots/screenshot-$(date '+%y%m%d-%H%M-%S').png") },
	{ MODKEY|ShiftMask,             XK_Print,  spawn,          SHCMD("sleep 0.2; maim -s | xclip -selection clipboard -t image/png") },
